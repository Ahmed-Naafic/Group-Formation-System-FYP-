...
const SelectTrigger = React.forwardRef(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ...
    className={cn(
      ...
      'text-sm placeholder:text-muted-foreground [&>span]:line-clamp-1',
  ...
  >
    ...
    <SelectPrimitive.Icon asChild>
      <ChevronDown size={15} className="opacity-50 shrink-0" />
...
const SelectItem = React.forwardRef(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ref={ref}
    className={cn(
      'relative flex w-full cursor-default select-none items-center rounded-sm py-1.5 pl-2 pr-8 text-sm text-ink-700 outline-none',
