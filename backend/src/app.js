...
app.use('/api/academic-years',   require('./modules/academicYear/routes/academicYearRoutes'));
app.use('/api/cohorts',          require('./modules/cohort/routes/cohortRoutes'));
app.use('/api/course-offerings', require('./modules/courseOffering/routes/courseOfferingRoutes'));
app.use('/api/attendance',       require('./modules/attendance/routes/attendanceRoutes'));
